...
const SiteMeta: FunctionComponent<WebsiteMetaProps> = ({data, settings, title, description, image, type, location}) => {
...
const SiteMetaQuery = props => (
  <StaticQuery
    ...
    `}
    render={data => <SiteMeta settings={data.allGhostSettings.edges[0].node} {...props} />}
  />
);
