...
const ArticleMeta: FunctionComponent<PostMetaProps> = ({post, settings, location}) => {
  ...
  return (
    <>
      <Helmet
        ...
        <meta property="og:site_name" content={'blog.conor-burns.com'}/>
        ...
        {post.primary_tag && <meta name="twitter:label2" content="Filed under"/>}
        {post.primary_tag && <meta name="twitter:data2" content={post.primary_tag.name}/>}
...
const ArticleMetaQuery = (props) => (
  ...
  `}
               render={data => <ArticleMeta settings={data.allGhostSettings.edges[0].node} {...props}/>} // tslint:disable-line
  />
);
